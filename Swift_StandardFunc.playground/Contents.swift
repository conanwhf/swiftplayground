...
func multi_element(){
    ...
    //
    constArr
    Array(Mirror(reflecting: constArr).children)
    let temp = Mirror(reflecting: constArr)
    for i in temp.children {
        i.value
    }
    
    //
    [1:[101,102], 2:102].underestimateCount()
...
/* Unknow APIs
//getVaList(constArr)
//isUniquelyReferenced(constArr)
//reinterpretCast(constArr)
//split(constArr)
//transcode(str)
//withUnsafePointer(str)
